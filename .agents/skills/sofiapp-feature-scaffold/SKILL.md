...
Reglas por app en sus `AGENTS.md`. Aplica también `multi-tenancy-guard`, `typescript-strict-mode`, `clean-code-solid`. **Backend = ESM + funcional** (sin clases, solo named exports).
