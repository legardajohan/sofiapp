...
SofiApp = **Screaming Architecture** (organización por feature) + **funcional** (sin clases en controllers/services). SOLID aplica a módulos y funciones. Reglas por app en sus `AGENTS.md`.
