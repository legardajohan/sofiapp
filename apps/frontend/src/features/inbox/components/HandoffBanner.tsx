 ...
 */
export function HandoffBanner({ motivo, at }: HandoffBannerProps): React.ReactElement {
  return (
    <div className="flex items-center gap-2 border-t border-border bg-muted/40 px-4 py-2.5 text-xs text-secondary-foreground">
      ...
      <span>
        ...
        <span className="text-muted-foreground"> · {MOTIVO_LABEL[motivo].toLowerCase()}</span>
