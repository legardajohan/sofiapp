...
> Archivo de contexto raíz para Codex. Léelo **completo** al iniciar cualquier sesión
...
| `apps/backend/AGENTS.md` | Reglas y patrón de feature del backend (6 archivos + montaje en `app.ts`). |
| `apps/frontend/AGENTS.md` | Reglas del frontend (apiClient único, Zustand, guards de rol). |
